...
| Variable                              | Purpose                                                                 |
|---------------------------------------|-------------------------------------------------------------------------|
| `MARINA_INGEST_URL`                   | (optional) Marina ingest endpoint. Default: `https://hara.mervare.app/api/ingest/telemetry` |
...
Then sign in to https://hara.mervare.app/login and open `/moi`. The
