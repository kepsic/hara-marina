...
```toml
[boat]
slug = "moi"               # MUST match the URL slug at hara.mervare.app/<slug>
...
- Sign in as the boat's owner email at `https://hara.mervare.app/login`.
- Open `https://hara.mervare.app/<slug>`.
...
req = urllib.request.Request(
    "https://hara.mervare.app/api/ingest/telemetry",
    method="POST",
