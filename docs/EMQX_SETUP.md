...
`https://hara-marina.vercel.app/<slug>`.
...
- **URL:** `https://hara-marina.vercel.app/api/ingest/telemetry`
- **Method:** `POST`
- **Headers:**
  - `Content-Type: application/json`
  - `Authorization: Bearer <MARINA_INGEST_TOKEN>`
...
curl -sS -X POST https://hara-marina.vercel.app/api/ingest/telemetry \
