...
export async function sendBookingConfirmed(booking) {
  const html = `
    ...
    <ul>
      ...
      <li><b>Hara Sadamaresto</b> (the harbour restaurant) and the harbour shop are on site.</li>
      <li><b>Activities:</b> SUP, kayak and rowboat hire from the port (15 €/hour or 15 €/1–3 h depending on craft).</li>
    </ul>
  ...
  return await send({
    ...
    subject: `Confirmed · Welcome to ${MARINA.name} · ${booking.arrival}`,
    html,
