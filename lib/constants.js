...
// Owner-editable equipment chips (boat portal Settings → Vessel tab and the
// marina-side detail panel). Kept in this client-safe module so the
// SettingsModal can import it without dragging in the server-only
// lib/boatSettings.js (which pulls in ioredis and breaks the browser bundle).
